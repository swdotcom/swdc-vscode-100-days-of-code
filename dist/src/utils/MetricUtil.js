...
exports.getSessionCodetimeMetrics = void 0;
...
function getMinutesCoded() {
    ...
    try {
        ...
        if (exists) {
            timeCounterMetrics = FileManager_1.getFileDataAsJson(timeCounterFile);
        }
        else {
            return minutes;
        }
    ...
    const day = timeCounterMetrics.current_day;
...
function getSessionCodetimeMetrics() {
    ...
    try {
        ...
        if (exists) {
            ...
            // checks if file was updated today
            if (Util_1.compareDates(new Date(), stats.mtime)) {
                metrics = FileManager_1.getFileDataAsJson(sessionSummaryFile);
            }
            else {
                return metricsOut;
            }
...
exports.getSessionCodetimeMetrics = getSessionCodetimeMetrics;
//# sourceMappingURL=MetricUtil.js.map